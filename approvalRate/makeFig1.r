# inspired in part by
# http://www.r-bloggers.com/how-to-plot-points-regression-line-and-residuals/library(calibrate)
png("fig1.png", width=800, height=400)
...
linearModel<-lm(hamp_approval_rate~1+popular_vote2012, df)
